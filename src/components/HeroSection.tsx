        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          {isMobile ? (
            ...
            <>
              ...
              <div className="order-1 md:order-2 w-full flex flex-col items-center md:items-start">
                <HeroCarousel />
                <p className="mt-3 text-sm text-gray-600 text-center w-full">THE FIRST LUXURY PRIVATE GYM BUILT FOR BEGINNERS</p>
              </div>
            </>
          )}
        </div>
