        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          {isMobile ? <>
              <div className="text-center order-1 w-full space-y-6">
                <HeroContent isInView={isInView} scrollToOwnBoth={() => {}} isMobile={true} overrideTitle="GYM FOR BEGINNERS" />
                ...
                <div className={cn("transition-all duration-1000 delay-500", isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8")}>
                  <div className="mt-4 space-y-1">
                    ...
                    <p className="text-gray-700 px-0 py-[4px] font-bold text-base">You’re exactly who FitAnywhere was built for.</p>
                  </div>
              ...
              <HeroContent isInView={isInView} scrollToOwnBoth={() => {}} overrideTitle="GYM FOR BEGINNERS" />
