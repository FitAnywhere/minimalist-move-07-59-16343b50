          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative perspective">
              <div className="relative overflow-hidden rounded-2xl shadow-xl transition-all duration-500 hover:shadow-xl hover:scale-[1.02] group" ref={videoRef}>
                ...
                <div style={{padding:"63.15% 0 0 0", position:"relative"}}>
                  <iframe 
                    src="https://player.vimeo.com/video/1074680511?h=e60416ada1&badge=0&autopause=0&player_id=0&app_id=58479&loop=1&background=1&muted=1" 
                    frameBorder="0" 
        ...
        <DialogContent className="sm:max-w-2xl">
          ...
          <div className="grid gap-8 md:grid-cols-2 mt-4">
            <div className="aspect-video bg-gray-100 rounded-lg overflow-hidden relative">
              ...
              <div style={{padding:"63.15% 0 0 0", position:"relative"}}>
                <iframe 
                  src="https://player.vimeo.com/video/1074680511?h=e60416ada1&badge=0&autopause=0&player_id=0&app_id=58479" 
                  frameBorder="0" 
                  allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media" 
                  style={{position:"absolute", top:0, left:0, width:"100%", height:"100%"}} 
                  title="training library optimized"
