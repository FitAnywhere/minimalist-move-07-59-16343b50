        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="mt-4 text-xl text-gray-600 max-w-3xl mx-auto">
              Urban minimalists share their experiences with the FitAnywhere solution
            </p>
          </div>
          ...
          <div className="relative">
            ...
            <button 
              ...
              className="absolute top-1/2 left-0 -translate-y-1/2 -translate-x-1/2 w-10 h-10 md:w-12 md:h-12 rounded-full bg-white shadow-lg flex items-center justify-center hover:bg-gray-50 transition-all z-10 focus:outline-none"
            ...
            <button 
              ...
              className="absolute top-1/2 right-0 -translate-y-1/2 translate-x-1/2 w-10 h-10 md:w-12 md:h-12 rounded-full bg-white shadow-lg flex items-center justify-center hover:bg-gray-50 transition-all z-10 focus:outline-none"
