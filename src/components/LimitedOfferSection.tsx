      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-700 mb-6 max-w-xl mx-auto font-medium py-4 my-3 text-xl">
          ...
          <p className="text-lg text-gray-700 mb-6 max-w-xl mx-auto font-medium text-center">
