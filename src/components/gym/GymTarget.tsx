                ...
                {targetAudiences.map((audience, index) => (
                  <div 
                    ...
                    className={cn(
                      ...
                      "rounded-2xl p-8 bg-white border-2 border-gray-100 hover:border-yellow hover:shadow-xl",
                  ...
                  <div className="flex justify-center">
                    {targetAudiences.map((audience, index) => (
                      ...
                      >
                        <div className="flex justify-center items-center mb-4">
                          <div className="w-[80%] h-auto overflow-hidden flex items-center justify-center">
                            <img 
                              ...
                              style={{ 
                                maxHeight: '300px',  // Increased height by ~45%
                                width: 'auto',
                                margin: '0 auto'
                              }}
                            />
                        ...
                        <p className="text-gray-700 text-base mx-auto" style={{ maxWidth: '85%' }}>
                          {audience.description}
                        </p>
                      </div>
                    ))}
                    ...
                    {targetAudiences.map((_, index) => (
                      <span 
                        ...
                        className={cn(
                          ...
                          index === activeIndex ? "bg-yellow w-4" : "bg-gray-300"
                        )}
                      />
                    ))}
                  </div>
