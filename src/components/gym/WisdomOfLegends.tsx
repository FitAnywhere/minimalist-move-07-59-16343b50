    ...
    <section ref={sectionRef} className="py-16" style={{
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-5xl mx-auto">
          ...
          {/* Guarantee Icon */}
          <div className={cn(
            "flex justify-center mb-8 transition-all duration-800",
            animationState.icon ? "opacity-100 scale-100" : "opacity-0 scale-75"
          )}>
            ...
            {bulletPoints.map((point, index) => (
              <div
                ...
                className={cn(
                  ...
                  animationState.bullets[index] ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                )}
                style={{
