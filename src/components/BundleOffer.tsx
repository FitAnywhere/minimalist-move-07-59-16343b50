    ...
    >
      <div className="container mx-auto px-6">
        <div className="max-w-5xl mx-auto">
          ...
          <div 
            className={cn(
              "mt-12 bg-gray-50 rounded-2xl overflow-hidden shadow-lg border border-gray-100 transition-all duration-500",
          ...
          >
              ...
              <div className="mt-8 pt-8 border-t border-gray-200">
                <div 
                  className={cn(
                    ...
                    showSavings ? "max-h-[500px]" : "max-h-0"
                  )}
                >
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between">
                  <button
                    ...
                    className="flex items-center text-sm font-medium text-gray-600 hover:text-black transition-colors mb-4 sm:mb-0"
                  >
                    {showSavings ? (
                      <>Hide Savings Details <ChevronUp className="ml-1 w-4 h-4" /></>
                    ) : (
                      <>View Savings <ChevronDown className="ml-1 w-4 h-4" /></>
                    )}
                  </button>
            ...
            <div className="bg-gray-900 p-8 text-center">
              <a 
                href="#order"
                className="inline-flex items-center bg-yellow text-black hover:bg-yellow-dark px-8 py-4 rounded-full text-lg font-semibold tracking-wide transition-all duration-300 hover:shadow-lg hover:-translate-y-1 button-glow"
              >
                GET THE COMPLETE BUNDLE NOW
              </a>
              <p className="mt-4 text-sm text-gray-400">
                Limited stock available for Spring 2025 launch
              </p>
            </div>
          </div>
        </div>
