...
const BundleOffer = () => {
  ...
  return (
    <section id="bundle" ref={sectionRef} className="py-16 relative overflow-hidden bg-gray-50">
      {/* Parallax Background */}
      <div 
        ref={parallaxRef} 
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-5xl mx-auto">
          ...
          <div 
            ...
            style={{ boxShadow: "0 4px 16px rgba(0,0,0,0.08)", borderRadius: "8px" }}
          >
            <div className="p-4">
              ...
              <div className="mt-2 max-w-3xl mx-auto text-left text-gray-700">
                <p className="mb-3 text-lg leading-tight">
              ...
              <div className="space-y-1">
                {bundleItems.filter(item => !item.isBonus).map((item, index) => (
                  <div 
                    key={index}
                    className={cn(
                      "flex items-center justify-between p-1.5 rounded-lg bg-white transition-all duration-500 transform",
                      "hover:bg-gray-50",
              ...
              <div className="mt-3">
                <Collapsible
                  open={bonusSectionOpen}
                  onOpenChange={setBonusSectionOpen}
                  className="p-2 rounded-lg border border-yellow-100 transition-all duration-300"
                >
                  ...
                  <CollapsibleContent className="mt-2 space-y-1.5 transition-all duration-300 ease-in-out">
                    {bundleItems.filter(item => item.isBonus).map((item, index) => (
                      <div 
                        key={index}
                        className="flex items-center justify-between p-1.5 rounded-lg bg-white transition-all hover:shadow-sm border border-yellow-50"
                      >
                        <div className="flex items-center gap-2">
                          <div className="flex-shrink-0">
              ...
              <div className="mt-3">
                <Collapsible
                  open={valueSectionOpen}
                  onOpenChange={setValueSectionOpen}
                  className="p-2 bg-gray-50 rounded-lg transition-all duration-300"
                >
                  <div className="flex items-center justify-between">
