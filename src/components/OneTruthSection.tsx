...
const OneTruthSection = () => {
  ...
  const renderTextContent = () => <div className={cn("space-y-6", isMobile ? "text-center" : "text-left")}>
      ...
      <div className={cn("transition-all duration-1000 transform space-y-4", isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10", isMobile ? "text-center" : "text-left")} style={{
