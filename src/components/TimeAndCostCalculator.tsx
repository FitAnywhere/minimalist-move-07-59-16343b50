        ...
        <div className="max-w-5xl mx-auto">
          <div className={cn("transition-all duration-1000", isInView ? "opacity-100" : "opacity-0 translate-y-10")}>
            <div className="text-center mb-16">
              ...
              <p className={cn("text-lg md:text-xl font-medium text-gray-700 mt-4", isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-5")}>
                Discover the Hidden Cost of "Staying Fit" that no one talks about.
              </p>
