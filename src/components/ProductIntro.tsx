        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <h2 className="text-black">
              ...
              <span className="block mt-2">The Centerpiece of Your Premium Home Gym</span>
            </h2>
            
            <p className="mt-6 text-xl">
              Crowded gyms and subscription fatigue are a thing of the past. Meet PowerTower – crafted for high-performing urban minimalists.
            </p>
          </div>
          ...
          <div className="mt-12">
            ...
            <button
              ...
              className="mt-8 flex items-center justify-center mx-auto bg-white border border-gray-200 px-6 py-3 rounded-full text-sm font-medium hover:bg-gray-50 transition-all hover-lift"
            >
              {expanded ? (
