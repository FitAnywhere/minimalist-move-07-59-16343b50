...
const ProductIntro = () => {
  ...
  useEffect(() => {
    if (isInView) {
      ...
      setTimeout(() => setAnimationState(prev => ({ ...prev, subtitle: true })), 800);
      setTimeout(() => setAnimationState(prev => ({ ...prev, paragraph: true })), 1300);
      ...
      setTimeout(() => setAnimationState(prev => ({ ...prev, finalLine: true })), 3000);
    }
  }, [isInView]);
          ...
          <div className="grid md:grid-cols-2 gap-6 items-center">
            ...
            <div className="space-y-8 order-last md:order-first">
              ...
              <div className="space-y-4">
                <h2 
                  className={cn(
                    "text-black font-bold tracking-wide transition-all duration-700 transform",
                ...
                <p 
                  className={cn(
                    "text-2xl text-gray-800 font-medium transition-all duration-700 transform",
                ...
                <p 
                  className={cn(
                    ...
                    animationState.paragraph ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
                  )}
                >
                ...
                <Collapsible open={isOpen} onOpenChange={setIsOpen} className="space-y-4">
                  {features.map((feature, index) => (
                    ...
                    >
                      <Card 
                        className={cn(
                          "p-4 rounded-lg bg-white border border-yellow-100 hover:shadow-md transition-all duration-300",
                          "hover:-translate-y-1 hover:border-yellow-300 group"
                        )}
                      >
                  ...
                  <div className="flex justify-center">
                    <CollapsibleTrigger asChild>
                      <Button 
                        variant="outline" 
                        size="sm"
                        className="mt-2 border-yellow-200 hover:border-yellow-400 hover:bg-yellow-50"
                      >
                        {isOpen ? (
                          <>
