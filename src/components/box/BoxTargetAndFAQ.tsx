        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="hidden md:grid md:grid-cols-2 md:gap-8 md:items-start">
            <div className="text-left flex flex-col justify-center h-full">
              {/* Desktop title moved to top of column */}
              <div className={cn("mb-8 transition-all duration-1000", isPerfectIfInView ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-8")}>
                <h2 className="text-3xl md:text-4xl font-extrabold text-black relative inline-block">
                  IT'S PERFECT IF
                  <span className={cn("absolute bottom-0 left-0 w-full h-1 bg-yellow-400 transform transition-transform duration-1000", isPerfectIfInView ? "scale-x-100" : "scale-x-0")}></span>
                </h2>
          ...
          <div className={cn("text-center py-6 max-w-3xl mx-auto transition-all duration-300 mb-8", isSpecialOfferInView ? "opacity-100 translate-y-0 animate-fade-in" : "opacity-0 translate-y-4")}>
            ...
            <div className={isMobile ? "max-w-md mx-auto mb-8" : "max-w-2xl mx-auto mb-8"}>
              <div className="p-6 flex flex-col items-center py-[35px]">
                <img src="https://res.cloudinary.com/dxjlvlcao/image/upload/f_auto,q_auto/v1745092806/Screenshot_16_qqtwbf.png" alt="BoxFun Offer" className="object-contain w-full md:w-[80%] rounded-2xl" loading="lazy" width="800" height="600" srcSet="
            ...
            <p className="text-gray-700 mb-6 max-w-xl mx-auto font-medium text-xl">GET A PRIVATE GYM 100€ OFF</p>
