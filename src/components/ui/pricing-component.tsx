        ...
        <div className="w-full max-w-3xl mx-auto px-4 py-12 md:py-20">
            <div className="relative">
                ...
                <button
                    ...
                    className={cn(
                        "hidden md:flex absolute -left-10 top-1/2 -translate-y-1/2 z-20",
                ...
                <button
                    ...
                    className={cn(
                        "hidden md:flex absolute -right-10 top-1/2 -translate-y-1/2 z-20",
                        "w-12 h-12 items-center justify-center rounded-full",
                        "bg-yellow-400 text-black border-2 border-black",
                        "shadow-[2px_2px_0px_0px] shadow-black",
                        "hover:shadow-[4px_4px_0px_0px] hover:translate-x-[-2px] hover:translate-y-[-2px]",
                    ...
                    >
                        {tiers.map((tier, index) => (
                            ...
                            >
                                <div
                                    className={cn(
                                        "relative flex flex-col p-5 rounded-lg border-2",
                                ...
                                >
                                    ...
                                    <div className="flex flex-col items-center">
                                        <Button
                                            className={cn(
                                                "w-full h-12 text-lg font-bold mb-2",
