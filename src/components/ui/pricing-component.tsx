...
function FitAnywherePricing({
    ...
    return (
        <div className="w-full max-w-sm mx-auto px-2 py-4 md:py-6">
            <div className="relative">
                ...
                <button
                    ...
                    className={cn(
                        ...
                        "hover:shadow-[3px_3px_0px_0px] hover:translate-x-[-1px] hover:translate-y-[-1px]",
                    ...
                    >
                        {tiers.map((tier, index) => (
                            ...
                            >
                                <div
                                    className={cn(
                                        "relative flex flex-col p-4 rounded-lg border-2 border-black",
                                        "bg-white shadow-lg max-w-xs mx-auto",
                                        tier.popular && "border-yellow shadow-yellow/50",
                                        "transition-all duration-300 ease-in-out"
                                    )}
                                >
                                    {tier.popular && (
                                        <div
                                            className="absolute -top-2 left-1/2 -translate-x-1/2 bg-yellow text-black 
                                            font-bold px-2 py-1 rounded-full text-xs uppercase tracking-wide shadow-md border-2 border-black z-10 whitespace-nowrap"
                                        >
                                            Most Popular
                                        </div>
                                    )}
                                    ...
                                    <Button
                                        className={cn(
                                            ...
                                            "shadow-[3px_3px_0px_0px] shadow-black",
                                            "hover:shadow-[4px_4px_0px_0px]",
