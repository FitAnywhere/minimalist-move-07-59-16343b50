...
const NumberFlow: React.FC<NumberFlowProps> = ({ 
  ...
  return (
    <span 
      className={cn(className, isAnimating && willChange ? "will-change-contents" : "")}
      style={{ 
    ...
    <div className={cn("w-full", className)}>
      <div className="relative flex justify-center items-center">
        ...
        <input
          ...
          className="custom-slider w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer focus:outline-none focus:ring-2 focus:ring-[#FFD700] focus:ring-opacity-50"
          style={{
          ...
          <div className="space-y-6">
            ...
            <div className="relative">
              ...
              <Input
                ...
                min={0}
                max={150}
                className="pl-10 pr-4 py-4 text-xl font-bold text-center bg-muted/30 border-border/50 rounded-xl focus:border-[#FFD700] focus:ring-[#FFD700] transition-all duration-300"
              />
            </div>
          </div>
        </motion.div>
          ...
          <div className="text-center p-6 bg-gradient-to-br from-[#FFD700]/10 to-[#FFD700]/5 rounded-2xl border-2 border-[#FFD700]/30">
            ...
            >
              ...
              <motion.div
                ...
                initial="initial"
                animate="animate"
                className="text-4xl md:text-5xl font-black text-[#FFD700] tracking-tight"
              >
                <NumberFlow
                  value={twentyYearSavings}
                  format={{
                    style: "currency",
                    currency: "EUR",
                    minimumFractionDigits: 0,
                  ...
                  willChange
                />
                <span className="text-2xl align-middle" style={{ verticalAlign: 'middle', lineHeight: '1' }}>+</span>
              </motion.div>
            </motion.div>
          </div>
        </motion.div>
