          ...
          {testimonials.map((testimonial, i) => (
            ...
            >
              <motion.img
                ...
                layoutId={`img-${testimonial.imageUrl}`}
...
function ThreeDPhotoCarousel({ testimonials }: { testimonials: Testimonial[] }) {
      ...
      <AnimatePresence mode="sync">
        {activeTestimonial && (
          <motion.div
            ...
            layoutId={`img-container-${activeTestimonial.imageUrl}`}
            layout="position"
            onClick={handleClose}
          ...
          >
            <motion.img
              layoutId={`img-${activeTestimonial.imageUrl}`}
