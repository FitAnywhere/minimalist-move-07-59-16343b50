...
const HeroContent = memo(({
  ...
  return <div className="text-center md:text-left">
      ...
      <p className={cn("mt-6 text-xl md:text-2xl text-gray-800 transition-all duration-1000 delay-200", isInView ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8")}>4 in 1 portable gym that adapts to your lifestyle</p>
