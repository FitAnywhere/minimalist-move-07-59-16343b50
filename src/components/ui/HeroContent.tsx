    ...
    <div className="text-center md:text-left">
      ...
      <div className={cn(
        ...
        <button
          ...
          className="inline-flex items-center bg-yellow text-black hover:bg-yellow-dark rounded-full text-lg font-semibold tracking-wide transition-all duration-300 hover:shadow-lg hover:-translate-y-1 group button-glow py-[15px] px-[58px] my-[20px] uppercase"
        >
          40% Off Launch Offer
